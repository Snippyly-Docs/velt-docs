...
You can provide us a webhook endpoint and we will send real time notifications data to you in processed format or raw format. We trigger a notification whenever a comment:
 - is 'added'
 - is  'updated'
 - is  'deleted'
 - is 'approved'
 - is  'assigned'
 - is  'reopened'
 - has its status changed ('statusChanged' attribute)
 - has its priority has changed ('priorityChanged' attribute)
