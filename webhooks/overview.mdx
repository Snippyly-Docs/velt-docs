...
You can provide us a webhook endpoint and we will send real time notifications data to you in processed format or raw format. We trigger a notification when:
 - a comment is 'added'
 - a comment is  'updated',
 - a comment is  'deleted',
 - a comment is 'approved',
 - a comment is  'assigned',
 - a comment is  'reopened',
 - a comment status has changed ('statusChanged' attribute)
 - a comment priority has changed ('priorityChanged' attribute)
