...
```js
<!-- `true` to show comments, `false` to hide comments -->
<velt-comments commentsOnDom="false"></velt-comments>
```
...
```js
<velt-comments dialogOnHover="true"></velt-comments>
````
...
```js
<velt-comments dialogOnTargetElementClick="true"><velt-comments>
````
...
```js
<velt-comments floatingCommentDialog="true"></velt-comments>
````
