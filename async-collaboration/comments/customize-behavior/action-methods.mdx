...
<Step title="Get the Xpath of the DOM element on which the comment was added">
...
<Step title="Scroll the page directly to the comment element">
...
export default function YourDocument() {
  ...
  useEffect(()=>{
    ...
    if(client){
      ...
      commentElement.addCommentOnElement(element) // 4
      let elementRef = commentElement.getElementRefByAnnotationId('annotationId') // 5
      commentElement.scrollToCommentByAnnotationId('annotationId') // 6
