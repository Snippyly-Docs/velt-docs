...
## 2) Add `VeltComments` component with Stream mode
...
Select any text, a comment tool will appear near the highlighted text. 
...
Click on it to add a comment and see the comment appear in the comment stream.
    ...
    <Tab title="HTML">
## 1) Add `<velt-comments>` component with Stream mode
