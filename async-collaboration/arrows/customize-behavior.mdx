...
<Tabs>
    <Tab title="React">
## 1) Enable Dark Mode
To enable dark mode, set the darkMode attribute to `true` on the VeltArrowsTool component.

```js
<VeltArrowsTool darkMode={true}/>
```
...
```
    ...
    <Tab title="HTML">
## 1) Enable Dark Mode
To enable dark mode, set the dark-mode attribute to `true` on the velt-arrows-tool component.

```html
<velt-arrows-tool dark-mode='true'></velt-arrows-tool>
```
</Tab>
