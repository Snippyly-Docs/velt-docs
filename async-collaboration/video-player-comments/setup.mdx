...
In your callback, you can use the Comment data's **location** property to set the video player timeline to the same timestamp that is associated with the Comment that was just clicked.
