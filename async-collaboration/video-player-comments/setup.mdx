...
## 2) Add VeltProvider to the root of your app and pass in your API key.
...
You can use this to pause your video player whenever a new comment is being made and set a new Location for your video player to match the current comment being made.
...
Call removeLocation() when your video player starts playing:
```jsx
...
Add the `onCommentClick` event handler on the `VeltCommentPlayerTimeline` component you added earlier.
