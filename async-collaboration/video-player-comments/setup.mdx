...
You can use this to pause your video player whenever a new comment is being made and set a new Location for your video player to match the current comment.
