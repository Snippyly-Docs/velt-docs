...
api: "POST https://us-central1-snippyly-sdk-prod.cloudfunctions.net/deleteSystemComment"
---
...
To delete a specific child comment, you can use the same endpoint except you need to modify your data body to include an `annotationId` field. The `annotationId` field will contain the parent annotation ID that the child will be removed from.
