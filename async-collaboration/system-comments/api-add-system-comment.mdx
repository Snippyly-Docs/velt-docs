...
To add a system comment via the API, send a POST request to `https://us-central1-snipply-sdk-staging.cloudfunctions.net/addSystemComment` with the following body data.
...
### Priority Order of Text to Be Repalced
