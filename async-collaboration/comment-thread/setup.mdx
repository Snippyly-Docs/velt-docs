...
<Step title="Import the VeltCommentThread component and the useCommentAnnotation() hook. ">

Import the `VeltCommentThread` component and the `useCommentAnnotation()` hook.
