...
description: "Autheticate your logged in users with the SDK. Then initialize a collaborative space within your app to use Velt"
---
...
<Tabs>
 ...
 ## 1) Create a component that will represent your multi-collaborative space.

Create a component that will represent your multi-collaborative space.
...
Users logged into the same document ID can see each other's presence, cursors, comments etc. You can create multiple documents within your application to create separate collaborative spaces.
