...
```html
<velt-presence flockMode="true"></velt-presence>
```
...
```html
<velt-presence onPresenceUserChange="yourMethod()"></velt-presence>
```
...
```html
<velt-presence darkMode="true"></velt-presence>
```
  ...
  <body>
    <div class="toolbar">
      <velt-presence
        ...
        flockMode='true' // 4) Enable Flock Mode
        onPresenceUserChange="yourMethod()" //5) Subscribe to changes in User Presence
