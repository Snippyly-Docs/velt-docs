...
<Step title="Enable custom navigation">
...
<Step title="Disable default Follow Me navigation">
...
<Step title="Start or Stop Following a User">
...
When the leader of a `Follow Me` session navigates, this callback will be called.
