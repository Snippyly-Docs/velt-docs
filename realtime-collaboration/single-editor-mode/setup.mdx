...
liveStateSyncElement.isUserEditor().subscribe((userEditorAccess) => {
		// your logic here...
    //userEditorAccess.editor <-- True if user is editor
    //userEditorAccess.editorOnCurrentTab <-- true if the user is editor on current tab
});
```
...
export default function YourDocument() {
  ...
  console.log("Is User Editor?: ", editor)
