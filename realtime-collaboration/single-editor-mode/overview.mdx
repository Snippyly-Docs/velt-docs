...
You can restrict this behavior to only certain HTML containers & their children. You can use the `singleEditorModeContainerIds()` method which takes in an array of element ID strings. These IDs represent the parent elements you want us to control access for.
