...
<ResponseField name="container" type="N/A">
Targets the root cursor container. 
</ResponseField> 

<ResponseField name="svg" type="string">
Targets the cursor svg icon.  
</ResponseField>

<ResponseField name="huddle-avatar-container " type="object">
Targets the cursor avatar specific to huddle mode. You can learn more about this in the Huddle Feature.</ResponseField>
<ResponseField name="avatar-container" type="string">

Targets the avatar container specific to avatar mode. 
</ResponseField>

<ResponseField name="label-container" type="string[]">
Targets the label container. 
</ResponseField>
