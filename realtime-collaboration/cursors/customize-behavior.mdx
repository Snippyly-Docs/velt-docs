...
<Warning>You must pass a string info allowedElementIds currently instead of an object</Warning>
...
## 5) Enable Dark Mode (coming soon)
  ...
  return (
    <VeltProvider apiKey="API_KEY">
      <VeltCursor
        ...
        darkMode={true} {/* 5) Enable Dark Mode (coming soon)*/}
      />
    </VeltProvider>
  );
}
...
<html lang="en">
  ...
  <body>
    <velt-cursor
      ...
      dark-mode='true' <!-- 5) Enable Dark Mode (coming soon)-->
    ></velt-cursor>
  </body>
</html>
```
