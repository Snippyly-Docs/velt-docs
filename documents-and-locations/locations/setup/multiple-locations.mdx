...
<Step title="Mark location containers with data attributes">
...
Add the `data-velt-location` attribute to the container of an element where you want to link your location.
